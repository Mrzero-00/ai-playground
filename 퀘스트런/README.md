...
새 헤어·상의·하의·신발을 한 번에 확인하려면
`http://127.0.0.1:4173/preview/?look=showcase`를 엽니다. 쇼케이스 모드는 기존 저장 상태를 변경하지 않습니다.

## 현재 구현 범위

- 홈, 실시간 러닝, 퀘스트, 스타일 상점, 친구, 내 아바타 화면
- 풍성한 웨이브 헤어의 `루미`와 트랙 재킷·일자 쇼츠 차림의 `모리`로 구성된 새싹 모티프 애니메이션 SD 러너
- 러닝 기록과 보유 아이템을 유지한 채 여자·남자 캐릭터 타입 전환
...
- 눈·코·입·헤어스타일·머리장식·상의·하의·신발을 남녀 모두 부위별 3종 이상 선택
- 캐릭터 타입에 맞춰 자동 전환되는 남녀 전용 의상·헤어 이미지 레이어
- 업적으로 해금되는 안경·가방·시계 슬롯
