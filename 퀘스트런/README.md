...
아바타에 즉시 착용할 수 있습니다. 퀘스트 보상과 착용 상태는 브라우저에 자동 저장됩니다.
...
- 홈, 실시간 러닝, 퀘스트, 스타일 상점, 내 아바타 화면
- 둥근 비율과 새싹 모티프를 사용한 전용 러너 캐릭터 `루미`
...
- 러닝 코인으로 꾸미기 아이템 구매
- 모자·상의·신발·장식 슬롯별 아이템 착용
- 능력치 효과가 없는 순수 아바타 꾸미기
- 일일·주간·연속 달성 퀘스트와 지구력 기록
- 제주 한라봉 모자, 서울 한강 달빛 핀 등 숨은 지역 업적
...
GPS 러닝부터 러너 레벨, 퀘스트, 아바타 꾸미기까지 체험할 수 있는 MVP입니다.
