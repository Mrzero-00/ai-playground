...
| Single Foreign Currency Gross | 50% Review, 정책별 Hard |
...
interface AllocationRequestV1 {
  ...
  requestedRiskAmount?: DecimalString;
  currentPrice: DecimalString;
  availableCashBase: DecimalString;
  evaluationId: string;
  tradePlanId?: string;
  portfolioSnapshot: PortfolioSnapshotV1;
  policy: PortfolioPolicyV1;
  liquidity: LiquidityCapacityInput;
  sizingSignal: LongTermSizingSignal | MomentumSizingSignal;
  snapshotIds: string[];
}
```
...
- [ ] Ledger/NAV/Cash 이중 계산 방지
- [ ] 85/15 Target·Soft·Hard 분리
- [ ] Core/Future Core/Momentum Size 구현
- [ ] 동일 기업 Dual Lot 총노출
- [ ] Sector/Theme/Currency Look-through
- [ ] Momentum Risk/Open Risk 수량 역산
- [ ] Liquidity·FX·비용·Round Lot
- [ ] Rebalance·Stress·Cash 선택

### 안전

- [ ] Hard Limit 초과 신규 증가 0
- [ ] Stop/Gap 없는 Momentum 수량 0
- [ ] 전략 간 자금 차입 0
- [ ] Risk/User 승인 우회 0
- [ ] Leverage/음수 Cash 0
- [ ] 만료 Proposal 실행 0
...
- [ ] v1 Proposal·Batch·Exposure·Open Risk·Stress API
- [ ] Audit·Outbox·Idempotency
- [ ] Snapshot/Proposal/Capacity 불변
- [ ] Composite FK·RLS
