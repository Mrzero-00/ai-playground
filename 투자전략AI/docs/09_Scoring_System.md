...
- [ ] Scope·Direction·Availability·Status 타입
- [ ] Model/Factor/Weight Validator
- [ ] 정규화·N/A·Range·Confidence
- [ ] Gate/Action/Size 분리
...
- [ ] Scoring Validate/Evaluate/Get/Rank/Explain API
- [ ] Repository·Audit·Outbox·Idempotency
- [ ] `010_scoring_system_v1.sql`
- [ ] RLS·Composite FK·불변 Trigger

### 호환·검증

- [ ] 기존 Engine Blocked 0 Sentinel 격리
- [ ] Long-term/Momentum 회귀 테스트
- [ ] Unit/Property/API Integration
- [ ] Migration 정적 검토
