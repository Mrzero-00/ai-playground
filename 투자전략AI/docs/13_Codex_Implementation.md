...
기준 문서: `01_Architecture.md` v2.3, `02_Investment_Philosophy.md` v2.2.1, `03_LongTerm_Engine.md` v1.0.0-draft, `04_Momentum_Engine.md` v1.0.0-draft, `05_Portfolio_Engine.md` v1.0.0, `06_Learning_Engine.md` v1.0.0, `07_AI_Agents.md` v1.0.0, `08_Database.md` v1.0.0, `09_Scoring_System.md` v1.0.0
...
- Supabase `001`~`009` 실제 적용과 Auth/RLS 교차 사용자 E2E
