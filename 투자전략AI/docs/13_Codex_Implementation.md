...
| 14 | Automated Trading Execution | v1.2.0 | R1 Foundation Implemented | Intent, Preflight, Toss Adapter, In-process Idempotency, Reconciliation Schema |
...
- Open Gate: Main API Handoff, Preview Migration, 영속 Idempotency Ledger 연결, PAPER Forward Run, 토스 Read-only 대사, Security Review, LIVE Canary
