export type AuditAction =
  ...
  | "SCORING_MODEL_TRANSITIONED"
  | "SCORING_SCORECARD_EVALUATED"
  | "SCORING_CHANGE_EXPLAINED"
  | "SCORING_REPLAY_COMPLETED"
  | "REPORT_TEMPLATE_VALIDATED"
  | "REPORT_TEMPLATE_TRANSITIONED"
  | "REPORT_GENERATED"
  | "REPORT_REVISED"
  | "REPORT_REPLAY_COMPLETED"
  | "ROADMAP_PLAN_VALIDATED"
  | "ROADMAP_PLAN_REVISED"
  | "RELEASE_EVIDENCE_CREATED"
  | "ROADMAP_REPLAY_COMPLETED"
